...
const COMBOS: Record<string, Describer> = {
  ...
  "CREATE:IrsTable": (d) => withDetails("Criou uma tabela de IRS", d),
  "DELETE:IrsTable": (d) => withDetails("Eliminou uma tabela de IRS", d),
  ...
  "UPDATE:PayslipLayoutSettings": () => "Atualizou o layout do recibo de vencimento",
...
const ENTITY_LABELS: Record<string, string> = {
  ...
  PayslipLayoutSettings: "layout do recibo de vencimento",
  Task: "tarefa",
};
