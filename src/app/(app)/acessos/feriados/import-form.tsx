...
const initialState: HolidayImportState = {};

export function HolidayImportForm() {
  const [state, formAction, pending] = useActionState(importHolidaysAction, initialState);
      ...
      {state.result && (
        <div className="rounded-md border border-stone-200 bg-stone-50 p-3 text-sm">
          <p className="font-medium text-stone-800">
            {state.result.created} de {state.result.total} feriados importados.
          </p>
